...
nev_file = '20190304_Greyson_Cage_001.mat'
# ---------- The second file is INTAN .rhd file for EMG recordings ---------- #
rhd_file = '20190304_Greyson_Cage__190304_144134.rhd'

# --------- Create a cage_data instance ---------- #
my_cage_data = cage_data()
# ---------- Start compiling ---------- #
empty_channels = [7, 79] # We used these two channels as software reference during most experiments before 2019-07-01
my_cage_data.create(data_path, nev_file, rhd_file, empty_channels, do_notch = 1)
